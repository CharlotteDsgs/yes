...
export default function RsvpOpenClient() {
  ...
  // Bounce peek overlay: show animated fixed panel, hide after animation
  useEffect(() => {
    if (!rsvpPeek) return;
    setPeekVisible(true);
  ...
  if (step === "animation" && cfg && tpl && palette) {
    ...
    return (
      <>
        ...
        {/* Bounce peek overlay — fixed panel, pointer-events none, auto-hides after animation */}
