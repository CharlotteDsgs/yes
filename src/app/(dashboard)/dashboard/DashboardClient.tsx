        ...
        <div style={{ background: "linear-gradient(160deg, #FFF5F0 0%, #FFE8EE 100%)" }}>
          ...
          <div className="max-w-5xl mx-auto px-8 py-16 flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="flex-shrink-0 hidden md:block">
              <div style={{ width: 540, height: 300, borderRadius: 18, overflow: "hidden", border: "4px solid #7A1535", boxShadow: "0 24px 70px rgba(109,29,62,0.28)", position: "relative" }}>
                <img src="/screenshot-liste-cadeaux.png" alt="Aperçu liste de mariage" style={{ position: "absolute", width: "195%", top: "50%", left: "50%", transform: "translate(-50%, -50%) rotate(-22deg)", display: "block" }} />
              </div>
            </div>
          </div>
                    ...
                    <div style={{ width: W, height: H + CHROME, transform: `scale(${previewScale})`, transformOrigin: "top left" }}>
                      <div style={{ height: CHROME, backgroundColor: "#D8D1CA", display: "flex", alignItems: "center", gap: 12, padding: "0 16px" }}>
                        ...
                        <div style={{ flex: 1, backgroundColor: "rgba(255,255,255,0.7)", borderRadius: 6, padding: "6px 12px", fontSize: 12, color: "#888", textAlign: "center", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                          https://weddy-app.vercel.app/mariage/{registry.slug}
                        </div>
                        <button
            ...
            {slugEditing ? (
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center rounded-lg overflow-hidden border border-[#6D1D3E] bg-[#FFF5F0] flex-1">
                  <span className="pl-2 pr-0.5 text-xs text-[#6D1D3E]/40 whitespace-nowrap" style={{ fontFamily: "var(--font-display)" }}>https://weddy-app.vercel.app/mariage/</span>
                  <input
                    autoFocus
                    value={slugDraft}
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm" style={{ fontFamily: "var(--font-display)" }}>
                  <span style={{ color: "rgba(109,29,62,0.4)" }}>https://weddy-app.vercel.app/mariage/</span><span
          ...
          >
            <div className="flex items-center gap-2 min-w-0">
              ...
              <span className="text-sm truncate" style={{ color: "rgba(109,29,62,0.5)", fontFamily: "var(--font-serif)", fontStyle: "italic", fontWeight: 300 }}>
                https://weddy-app.vercel.app/mariage/{slug}
              </span>
            </div>
            <button
                onClick={() => {
