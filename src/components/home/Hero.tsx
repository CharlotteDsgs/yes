        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="flex flex-col gap-6">
            <div
              ...
              style={{ border: "3px solid #C4607A", aspectRatio: "16/10", position: "relative", width: "85%", boxShadow: "0 0 0 8px rgba(196,96,122,0.3), 0 0 0 16px rgba(196,96,122,0.12)" }}
            >
          ...
          <div className="flex flex-col gap-6">
            <div
              className="mx-auto rounded-3xl overflow-hidden"
              style={{ border: "3px solid #737A2D", aspectRatio: "16/10", position: "relative", width: "85%", boxShadow: "0 0 0 8px rgba(115,122,45,0.3), 0 0 0 16px rgba(115,122,45,0.12)" }}
            >
